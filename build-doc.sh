...
RESOURCE_SEARCH_PATH="src/main/markdown/Appendix/:src/main/markdown/Beyond POS:src/main/markdown/Backoffice:src/main/markdown/Tax/:src/main/markdown/Orders/:src/main/markdown/Training Mode/:src/main/markdown/Peripherals/:src/main/markdown/Coupons/:src/main/markdown/Sales/:src/main/markdown/UI & Screen Conventions/:src/main/markdown/User Management/:src/main/markdown/Daily Operations/:src/main/markdown/Item Inquiry/:src/main/markdown/Returns Management/:rc/main/markdown/Tendering/:src/main/markdown/Receipts/:src/main/markdown/Customers/:src/main/markdown/Promotions/"
