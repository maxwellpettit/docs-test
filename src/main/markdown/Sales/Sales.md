...
![transaction-menu](assets/transaction-menu.png)

 This menu allows you to access relevant and essential functionalities that take affect on an entire transaction.
...
#### Rewards
Loyalty information can be found HERE 
...
- ##### Transaction Information
    The number transaction per day, along with a running timer of the given transaction.
